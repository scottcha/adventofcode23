...
fn main() -> io::Result<()>{
    ...
    let path = Path::new("day7_part2_input.txt");
    //let path = Path::new("day7_part2_test_input.txt");
...
fn card_hand_type(hand: &str) -> u32
{
    ...
    else if counts.values().any(|&count| count == 3)
    {
        ...
        //num_jokers == 2 would have been caught by full house check
        else
        {
            return 4;
        }
